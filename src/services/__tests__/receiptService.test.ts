...
describe("Receipt Service", () => {
    ...
    describe("saveReceipt fn", () => {
        it("should save the receipt to cache", () => {
            ...
            expect(setCacheItem).toHaveBeenCalledWith("receipt:247aaa34-4d1d-412c-b636-98da08fba8c5", receiptMock);
        });
    ...
    describe("getReceipt fn", () => {
        it("should return a receipt from cache if found", () => {
            ...
            expect(getCacheItem).toHaveBeenCalledWith("receipt:247aaa34-4d1d-412c-b636-98da08fba8c5");
