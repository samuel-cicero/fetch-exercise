...
import { GetReceiptByIdResponse, GetReceiptPointsByIdResponse, PostReceiptRequestBody, PostReceiptResponse } from "../types/apiTypes";
...
export const processReceipt = (req: Request<{},{}, PostReceiptRequestBody>, res: Response<PostReceiptResponse>) => {
...
export const getReceiptById = (req: Request, res: Response<GetReceiptByIdResponse>) => {
...
export const getReceiptPointsById = (req: Request, res: Response<GetReceiptPointsByIdResponse>) => {
  const { id } = req.params;
