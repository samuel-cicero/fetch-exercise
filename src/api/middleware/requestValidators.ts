...
export const retailerValidtor = Joi.string()
    .trim()
    .required()
    .messages({
...
export const totalPriceValidator = Joi.string()
    ...
    .messages({
        ...
        "string.pattern.base": '"total" must be a valid number with optional two decimal places',
    });
...
export const itemPriceValidator = Joi.string()
    ...
    .messages({
        ...
        "string.pattern.base": '"price" must be a valid number with optional two decimal places',
    });
